...
export const CardsInspiracion = ({ titulo, descripcion }) => {
    return (
        <div className="card2" style={{ width: '35rem', minHeight: '20px', border: '2px solid #00ff99', backgroundColor: '#08310f3f', color: 'white', boxShadow: '0 0 10px rgba(0, 255, 153, 0.3)', margin: '12px', padding: '16px', borderRadius: '8px' }}>
