...
export const CardsCapitulos = ({ titulo, descripcion, img, onClick }) => {
    return (
        ...
        <>
            <div className="card3 hover-card" style={{ width: '25rem', border: '2px solid #00ff99', backgroundColor: '#08310f3f', color: 'white', boxShadow: '0 0 10px rgba(0, 255, 153, 0.3)', borderRadius: '8px', cursor: 'pointer', fontFamily: 'titulo' }} onClick={onClick}   >
